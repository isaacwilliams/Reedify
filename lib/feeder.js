...
(function() {
  var AppRouter, FeedItem, FeedItemList, FeedList, Navigation, ReedifyApp, UserData, Wrangler, app;
  ...
  UserData = (function() {
    ...
    UserData.prototype.template = window.Handlebars.templates.user_login;
  ...
  FeedItem = (function() {
    FeedItem.prototype.template = window.Handlebars.templates.feed_item;
    ...
    function FeedItem(data, feed) {
      ...
      $.extend(this, data);
      if (data.end) {
        this.template = window.Handlebars.templates.feed_item_end;
      }
    }
  ...
  FeedItemList = (function() {
    ...
    FeedItemList.prototype.template = window.Handlebars.templates.feed_item_list;
  ...
  Navigation = (function() {
    Navigation.prototype.template = window.Handlebars.templates.nav;

    Navigation.prototype.templateStreams = window.Handlebars.templates.nav_streams;
    ...
    Navigation.prototype.editStream = function(streamId) {
      var $editStream, editStream, filterCache, nav, selectedFeedIds, selectedFeeds, _feed, _i, _j, _len, _len1, _ref, _ref1, _stream;
      nav = this;
      editStream = {};
      if (streamId) {
        _ref = this.streams.streams;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          _stream = _ref[_i];
